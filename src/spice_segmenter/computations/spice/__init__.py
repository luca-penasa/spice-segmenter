...
``engine.register(ConcreteClass, ...)`` call here is keyed by the actual
...
def register_all(engine: SpiceEngine) -> None:
    ...
    engine.register(PhaseAngle, scalar_fn=phase_angle_scalar, vector_fn=phase_angle_vector)
    engine.register(AngularSize, scalar_fn=angular_size_scalar, vector_fn=angular_size_vector)
    engine.register(
        ApproximatedAltitude,
    ...
    engine.register(Occultation, scalar_fn=occultation_scalar, vector_fn=occultation_vector)
    ...
    engine.register(SubObserverRadius, scalar_fn=sub_sc_radius_scalar, vector_fn=sub_sc_radius_vector)
    engine.register(SubObserverLongitude, scalar_fn=sub_sc_longitude_scalar, vector_fn=sub_sc_longitude_vector)
    engine.register(SubObserverLatitude, scalar_fn=sub_sc_latitude_scalar, vector_fn=sub_sc_latitude_vector)
    ...
    engine.register(SubObserverGeoLongitude, scalar_fn=sub_sc_geo_longitude_scalar, vector_fn=sub_sc_geo_longitude_vector)
    engine.register(SubObserverGeoLatitude, scalar_fn=sub_sc_geo_latitude_scalar, vector_fn=sub_sc_geo_latitude_vector)
    engine.register(SubObserverAltitude, scalar_fn=sub_sc_altitude_scalar, vector_fn=sub_sc_altitude_vector)
    ...
    engine.register(SubObserverX, scalar_fn=sub_sc_x_scalar, vector_fn=sub_sc_x_vector)
    engine.register(SubObserverY, scalar_fn=sub_sc_y_scalar, vector_fn=sub_sc_y_vector)
    engine.register(SubObserverZ, scalar_fn=sub_sc_z_scalar, vector_fn=sub_sc_z_vector)
    ...
    engine.register(BoresightLatitude, scalar_fn=boresight_latitude_scalar)
    engine.register(BoresightLongitude, scalar_fn=boresight_longitude_scalar)
    engine.register(BoresightRadius, scalar_fn=boresight_radius_scalar)
    ...
    engine.register(BoresightGeoLatitude, scalar_fn=boresight_geo_latitude_scalar)
    engine.register(BoresightGeoLongitude, scalar_fn=boresight_geo_longitude_scalar)
    engine.register(BoresightAltitude, scalar_fn=boresight_altitude_scalar)
    ...
    engine.register(BoresightX, scalar_fn=boresight_x_scalar)
    engine.register(BoresightY, scalar_fn=boresight_y_scalar)
    engine.register(BoresightZ, scalar_fn=boresight_z_scalar)

    # Target RA/Dec
    engine.register(TargetRaDec, scalar_fn=target_radec_scalar, vector_fn=target_radec_vector)
    engine.register(TargetRA, scalar_fn=target_ra_scalar)
    engine.register(TargetDec, scalar_fn=target_dec_scalar)

    # Boresight RA/Dec
    engine.register(BoresightRaDec, scalar_fn=boresight_radec_scalar, vector_fn=boresight_radec_vector)
    engine.register(BoresightRA, scalar_fn=boresight_ra_scalar)
    engine.register(BoresightDec, scalar_fn=boresight_dec_scalar)
    ...
    engine.register(SubObserverIncidenceAngle, scalar_fn=sub_observer_incidence_angle_scalar)
    engine.register(SubObserverEmissionAngle, scalar_fn=sub_observer_emission_angle_scalar)
    engine.register(SubObserverPhaseAngleLocal, scalar_fn=sub_observer_phase_angle_local_scalar)
    ...
    engine.register(SubObserverIsInDaylight, scalar_fn=sub_observer_is_in_daylight_scalar)
    engine.register(AngularSeparation, scalar_fn=angular_separation_scalar)
    engine.register(SubObserverPointVelocity, scalar_fn=sub_observer_point_velocity_scalar)
    ...
    engine.register(Vector, scalar_fn=vector_scalar, vector_fn=vector_vector)
    engine.register(
        SubObserverPoint,
        scalar_fn=sub_observer_point_scalar,
        vector_fn=sub_observer_point_vector,
    )
    engine.register(Boresight, scalar_fn=boresight_scalar)
    engine.register(BoresightIntersection, scalar_fn=boresight_intersection_scalar)
    engine.register(BoresightIntersects, scalar_fn=boresight_intersects_scalar)
    engine.register(LatitudinalCoordinates, scalar_fn=latitudinal_scalar)
    engine.register(SphericalCoordinates, scalar_fn=spherical_scalar)
    engine.register(CylindricalCoordinates, scalar_fn=cylindrical_scalar)
    engine.register(GeodeticCoordinates, scalar_fn=geodetic_scalar)
    engine.register(PlanetographicCoordinates, scalar_fn=planetographic_scalar)
    engine.register(RaDecCoordinates, scalar_fn=radec_scalar)
    ...
    engine.register(ShineProperties, scalar_fn=shine_properties_scalar)
    engine.register(JupiterRise, scalar_fn=jupiter_rise_scalar)
    engine.register(JupiterRiseRatio, scalar_fn=jupiter_rise_ratio_scalar)
    ...
    engine.register(RingAnsaePhaseLowerThan, scalar_fn=ring_lower_than_scalar)
    engine.register(RingAnsaePhaseGreaterThan, scalar_fn=ring_greater_than_scalar)
    engine.register(RingAnsaePhaseWithinRange, scalar_fn=ring_within_range_scalar)
